...
public class Controller implements Initializable{
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		Image backImage = new Image("C:\\Users\\satish\\OneDrive\\Desktop\\WorkSpaces\\JavaFX\\Mp3Player\\images\\backward.jpeg");
		ImageView backImageView = new ImageView(backImage);
		backImageView.setFitWidth(30);
	    backImageView.setFitHeight(30);
	    previousButton.setGraphic(backImageView);
	        
		Image forwardImage = new Image("C:\\Users\\satish\\OneDrive\\Desktop\\WorkSpaces\\JavaFX\\Mp3Player\\images\\forward.jpeg");
		...
		Image loopImage = new Image("C:\\Users\\satish\\OneDrive\\Desktop\\WorkSpaces\\JavaFX\\Mp3Player\\images\\loopButton.png");
		...
		Image playImage = new Image("C:\\Users\\satish\\OneDrive\\Desktop\\WorkSpaces\\JavaFX\\Mp3Player\\images\\playButton.jpeg");
		...
		Image backGroundImage = new Image("C:\\Users\\satish\\OneDrive\\Desktop\\WorkSpaces\\JavaFX\\Mp3Player\\images\\mike.jpeg");
		...
		directory = new File("C:\\Users\\satish\\OneDrive\\Desktop\\WorkSpaces\\JavaFX\\Mp3Player\\music");
	...
	public void playControl() {
		if(play) {
			...
			playMedia();
			play = true;
			Image pauseImage = new Image("C:\\Users\\satish\\OneDrive\\Desktop\\WorkSpaces\\JavaFX\\Mp3Player\\images\\pauseButton.jpeg");
	...
	public void playMedia() {
		...
		Image playImage = new Image("C:\\Users\\satish\\OneDrive\\Desktop\\WorkSpaces\\JavaFX\\Mp3Player\\images\\pauseButton.jpeg");
		ImageView playImageView = new ImageView(playImage);
		playImageView.setFitWidth(30);
	    playImageView.setFitHeight(30);
		playButton.setGraphic(playImageView);
	    ...
	    task = new TimerTask() {
	        public void run() {
	            ...
	            Platform.runLater(() -> {
	                ...
	                if(metaData.get("album artist")!=null && metaData.get("composer")!=null && metaData.get("composer")!=null)
	                {
